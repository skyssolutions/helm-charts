...
helm repo update
helm install scrypted samipsolutions/scrypted
```
...
helm install scrypted \
  --set env.TZ="America/New York" \
    samipsolutions/scrypted
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install scrypted samipsolutions/scrypted -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/scrypted?modal=changelog)
