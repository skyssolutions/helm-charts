...
helm repo update
helm install cryptpad samipsolutions/cryptpad
```
...
helm install cryptpad \
  --set env.TZ="America/New York" \
    samipsolutions/cryptpad
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install cryptpad samipsolutions/cryptpad -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/cryptpad?modal=changelog)
