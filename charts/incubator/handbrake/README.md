...
helm repo update
helm install handbrake samipsolutions/handbrake
```
...
helm install handbrake \
  --set env.TZ="America/New York" \
    samipsolutions/handbrake
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install handbrake samipsolutions/handbrake -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/handbrake?modal=changelog)
