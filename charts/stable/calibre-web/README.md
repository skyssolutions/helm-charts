...
helm repo update
helm install calibre-web samipsolutions/calibre-web
```
...
helm install calibre-web \
  --set env.TZ="America/New York" \
    samipsolutions/calibre-web
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install calibre-web samipsolutions/calibre-web -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/calibre-web?modal=changelog)
