...
helm repo update
helm install jackett samipsolutions/jackett
```
...
helm install jackett \
  --set env.TZ="America/New York" \
    samipsolutions/jackett
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install jackett samipsolutions/jackett -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/jackett?modal=changelog)
