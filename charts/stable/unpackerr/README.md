...
helm repo update
helm install unpackerr samipsolutions/unpackerr
```
...
helm install unpackerr \
  --set env.TZ="America/New York" \
    samipsolutions/unpackerr
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install unpackerr samipsolutions/unpackerr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/unpackerr?modal=changelog)
