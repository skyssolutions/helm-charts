...
* <https://github.com/samipsolutions/helm-charts/tree/master/charts/omada-controller>
...
helm repo update
helm install omada-controller samipsolutions/omada-controller
```
...
helm install omada-controller \
  --set env.TZ="America/New York" \
    samipsolutions/omada-controller
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install omada-controller samipsolutions/omada-controller -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/omada-controller?modal=changelog)
