...
helm repo update
helm install deluge samipsolutions/deluge
```
...
helm install deluge \
  --set env.TZ="America/New York" \
    samipsolutions/deluge
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install deluge samipsolutions/deluge -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/deluge?modal=changelog)
