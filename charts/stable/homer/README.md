...
helm repo update
helm install homer samipsolutions/homer
```
...
helm install homer \
  --set env.TZ="America/New York" \
    samipsolutions/homer
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install homer samipsolutions/homer -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/homer?modal=changelog)
