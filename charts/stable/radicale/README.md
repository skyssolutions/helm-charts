...
helm repo update
helm install radicale samipsolutions/radicale
```
...
helm install radicale \
  --set env.TZ="America/New York" \
    samipsolutions/radicale
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install radicale samipsolutions/radicale -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/radicale?modal=changelog)
