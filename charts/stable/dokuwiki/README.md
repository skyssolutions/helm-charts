...
helm repo update
helm install dokuwiki samipsolutions/dokuwiki
```
...
helm install dokuwiki \
  --set env.TZ="America/New York" \
    samipsolutions/dokuwiki
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install dokuwiki samipsolutions/dokuwiki -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/dokuwiki?modal=changelog)
