...
helm repo update
helm install octoprint samipsolutions/octoprint
```
...
helm install octoprint \
  --set env.TZ="America/New York" \
    samipsolutions/octoprint
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install octoprint samipsolutions/octoprint -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/octoprint?modal=changelog)
