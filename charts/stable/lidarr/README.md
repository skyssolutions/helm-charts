...
helm repo update
helm install lidarr samipsolutions/lidarr
```
...
helm install lidarr \
  --set env.TZ="America/New York" \
    samipsolutions/lidarr
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install lidarr samipsolutions/lidarr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/lidarr?modal=changelog)
