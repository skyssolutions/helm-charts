...
helm repo update
helm install sonarr samipsolutions/sonarr
```
...
helm install sonarr \
  --set env.TZ="America/New York" \
    samipsolutions/sonarr
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install sonarr samipsolutions/sonarr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/samipsolutions/sonarr?modal=changelog)
